...
export default function EventPackOpenMulti() {
  ...
  // Direct navigation / refresh has no draw payload → bounce back to events.
  useEffect(() => {
    if (!state || results.length === 0) navigate('/events', { replace: true });
